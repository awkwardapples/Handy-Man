...
export type { ProjectsContent, ProjectItem } from './Projects/types';
export type { WhyChooseUsContent, ValueProp } from './WhyChooseUs/types';
export type { FAQContent, FAQItem } from './FAQ/types';
