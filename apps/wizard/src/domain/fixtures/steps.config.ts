 ...
 *
 * Flow: shape → material → count → estimate → extras → site_photos → contact-and-address → optional-details
  ...
  steps: [
    ...
    },
    {
      ...
      fields: [
        ...
        {
          id: 'existing_steps_removal',
          key: 'existing_steps_removal',
          type: 'select',
          label: 'Are there existing steps to remove first?',
          required: false,
          options: [
            { value: 'yes', label: 'Yes' },
            { value: 'no', label: 'No' },
