/**
 * Plumbing wizard configuration (Step 5.9).
 *
...
export const plumbingWizardConfig: WizardConfig = {
  schemaVersion: 1,
  id: 'plumbing',
  quoteMode: 'manual',
      ...
      fields: [
        {
          ...
          type: 'textarea',
          label:
            'Please describe the plumbing work you need (e.g. leak, blocked drain, new fitting, boiler service)',
...
export const plumbingPricingConfig = manualQuotePricingStub;
