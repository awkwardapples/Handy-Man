/**
 * Carpentry wizard configuration (Step 5.9).
 *
...
export const carpentryWizardConfig: WizardConfig = {
  schemaVersion: 1,
  id: 'carpentry',
  quoteMode: 'manual',
  title: 'Carpentry',
      ...
      fields: [
        {
          ...
          type: 'textarea',
          label:
            'Please describe the carpentry work you need (e.g. shelving, furniture assembly, doors, custom builds)',
...
export const carpentryPricingConfig = manualQuotePricingStub;
