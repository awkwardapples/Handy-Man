...
- `composer test`: **274 passed, 4 skipped** (+24 from 6.5's 250: `InputSanitizerTest` unit tests + `SubmissionControllerTest` integration tests, Step 6.6)
- `composer analyse`: clean (PHPStan level 8, no errors)
...
- **Step 6.6 — Security Audit and Hardening** (July 2026). ADR-0037
  ...
  new tests (250→274), Vitest/bundle unchanged.
