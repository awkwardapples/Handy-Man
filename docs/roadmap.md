...
| 6.7                   | Complete | Skip and Submit Turnstile gating: closed a real bypass where Skip and Submit dispatched submission without waiting for Cloudflare Turnstile; isSubmissionBlocked() shared gate; ADR-0038 |
| 5.12                  | Planned  | SCB-specific deployment (first real client)                                                                                                                                              |
| 6.0                   | Planned  | Production IONOS deployment                                                                                                                                                              |
| 6.8+                  | Future   | Fresh SCB clone testing, second client                                                                                                                                                   |
